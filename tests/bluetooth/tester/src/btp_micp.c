...
static uint8_t micp_supported_commands(const void *cmd, uint16_t cmd_len,
...
static uint8_t micp_discover(const void *cmd, uint16_t cmd_len,
			     void *rsp, uint16_t *rsp_len)
{
...
static uint8_t micp_mute_read(const void *cmd, uint16_t cmd_len,
			      void *rsp, uint16_t *rsp_len)
{
	int err;
...
static uint8_t micp_mute(const void *cmd, uint16_t cmd_len,
			 void *rsp, uint16_t *rsp_len)
{
	int err;
